...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            {{ trans('global.create') }} {{ trans('cruds.newsPrediction.title_singular') }}
        </div>

        <div class="card-body">
            <form method="POST" action="{{ route("admin.news-predictions.store") }}" enctype="multipart/form-data">
                @csrf
                <div class="form-group">
                    <label class="required" for="title">{{ trans('cruds.newsPrediction.fields.title') }}</label>
                    <input class="form-control title-text {{ $errors->has('title') ? 'is-invalid' : '' }}" type="text"
                ...
                <div class="form-group">
                    ...
                    <input readonly
                           class="form-control is-popular-text {{ $errors->has('is_popular') ? 'is-invalid' : '' }}"
                           type="text" name="is_popular" id="is_popular" value="{{ old('is_popular', '') }}">
